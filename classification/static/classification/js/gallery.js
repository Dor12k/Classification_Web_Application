...
var haedlineh2 = document.getElementsByTagName("h2")[0]
var haedlineh1 = document.getElementsByTagName("h1")
...
function darkMode(){
    ...
    haedlineh2.style.color = "rgb(50, 50, 50)"

    for (let i = 0; i < haedlineh1.length; i++) {
        haedlineh1[i].style.color = "rgb(50, 50, 50)"
    } 
